...
public class RemoveLikeUseCase extends UseCase {

    private String username;
    private String token;
    private RequestBody body;

    public RemoveLikeUseCase(String username, String token, RequestBody body) {
    ...
    protected Observable buildUseCaseObservable() {
        ...
        return repo.deleteLike(username, token, body).map(new Func1<Event, Event>() {
            @Override
