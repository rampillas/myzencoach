...
public class NewObservationsUseCase extends UseCase {
    String user;
    String token;
    RequestBody body;

    public NewObservationsUseCase(String user, String token, RequestBody body) {
        this.user = user;
        this.token = token;
        this.body = body;
    }
    ...
    protected Observable buildUseCaseObservable() {
        ...
        return repo.addObservations(user, body, token);
    }
}
